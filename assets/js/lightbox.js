 ...
 * 여기서 하는 일은 그 폭 제한을 푸는 것뿐이다 — 더 좋은 파일을 받아오지 않는다.
 * 본문에 이미 원본이 내려와 있어서 라이트박스는 같은 파일을 그대로 쓴다.
 *
 * 근거와 버린 대안: docs/adr/0015-own-javascript.md
 */
(() => {
    /**
     * 클릭을 위임으로 받는 이유.
    ...
    document.addEventListener("click", (event) => {
        ...
        /**
         * 본문에 그려진 바로 그 파일을 쓴다. currentSrc는 브라우저가 실제로 받은
         * 주소라, 나중에 srcset이 들어와도(#26) 여기는 고치지 않아도 된다.
         */
